{*
* Template: Dashboard Utilisateur
* Path: modules/mqdashboard/views/templates/dashboard.tpl
*}
...
<div class="mq-dashboard">
    ...
    <div class="dashboard-content">
                    ...
                    <div class="order-card">
                        <div class="order-header">
                            ...
                            <div class="order-status">
                                <span class="status-badge {$order.order_state.color|lower}">
        ...
        <div class="dashboard-section vouchers-section">
            <div class="section-header">
                <h2 class="section-title">
                    <i class="material-icons">local_offer</i>
                    Mes Bons de Réduction
                </h2>
                <a href="{$urls.pages.discount}" class="section-action">
                    <i class="material-icons">arrow_forward</i>
                    Voir tout
                </a>
            </div>
                    ...
                    <div class="voucher-content">
                        ...
                        <div class="voucher-value">
                            {if $voucher.reduction_percent > 0}
                                <span class="reduction">{$voucher.reduction_percent}% de réduction</span>
                            {else}
                                <span class="reduction">{$voucher.reduction_amount}€ de réduction</span>
                            {/if}
                        </div>

                        <p class="voucher-validity">
                            Valable jusqu'au {$voucher.date_to|date_format:'%d/%m/%Y'}
                        </p>
                    </div>
                </div>
                {/foreach}
        ...
        <div class="dashboard-section alerts-section">
            <div class="section-header">
                ...
                <a href="{$urls.pages.my_account}#alerts" class="section-action">
            ...
            <div class="alerts-list">
                ...
                <div class="alert-card">
                    ...
                    <div class="alert-content">
                        <h4 class="alert-product">{$alert.product_name}</h4>
                        <p class="alert-message">Vous serez alerté quand ce produit sera disponible</p>
                    </div>
                </div>
                {/foreach}
            </div>
